...
write_feather(lakes, 'data/out/lakes_UCLA_munged_Pickens50.feather')
...
write_feather(tp, 'data/out/SampleTrends_Pickens50.feather')
```

# Look at the trends spatially.

```{r}
tp <- read_feather('data/out/SampleTrends_Pickens50.feather')
tp <- read_feather('data/out/SampleTrends_Pickens70.feather')
tp <- read_feather('data/out/SampleTrends_PeckPerm.feather')
#tp <- read_feather('data/out/SampleTrends_Pickens50.feather')
...
Quick look at timesereis binned by biome

```{r}
## This causes memory issues
yearlyBiomes <- read_feather("data/out/lakes_UCLA_munged_Pickens.feather")  %>%
...
sampChar <- read_feather("data/out/lakes_UCLA_munged_Pickens70.feather") %>%
